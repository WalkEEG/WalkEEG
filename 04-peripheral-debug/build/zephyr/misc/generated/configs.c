...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NUS_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_LOG_LEVEL, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_KEYS_LOG_LEVEL_INHERIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_KEYS_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SERVICE_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_VIRTIO_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_XSI_SINGLE_PROCESS_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CRC_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SETTINGS_LOG_LEVEL, 4);
